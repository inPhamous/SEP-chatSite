(function () {
    ...
    n.iteratee = function (a, b, c) {
        ...
        b = o(b, c);
        var d, e = a.length;
        if (e === +e) for (d = 0; e > d; d++) b(a[d], d, a);
        else {
            var f = n.keys(a);
    ...
    var __t, __p = "",
        __e = _.escape;
    with(obj) __p += "<div class='clearfix'>\n<h6>Give your chat room a name:</h6>\n<input data-input='firechat-room-name' type='text' placeholder='Group name...' style='margin-bottom: 5px;' maxlength='" + __e(maxLengthRoomName) + "'>\n</div>";
    return __p
    ...
    a.noConflict = function () {
        ...
        _setupDataEvents: function () {
            ...
            a.on("value", function (a) {
                if (a.val() === !0) for (var b in this._presenceBits) {
        ...
        arguments.length > 2 && (f = arguments[1]), d = f ? d.limitToLast(f) : d, d.once("value", function (a) {
            var c = a.val() || {}, d = {};
            for (var f in c) for (var g in c[f]) {
                d[f] = c[f][g];
                break
            }
            b.setTimeout(function () {
...
function (a) {
    ...
    b.noConflict = function () {
        ...
        i.bind("keydown", function (a) {
            ...
            if (13 === a.which && "" !== c) return i.val(""), d._chat.sendMessage(b, c),getid(), !1
        });
        ...
        var a = this,
            ...
            c = this.prompt("Create Public Group", b({
