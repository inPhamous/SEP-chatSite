   	     ...
   	     <div class="wrap">
   	       <div class="abstract">
		   	 <ul class="breadcrumb breadcrumb__t">
		   	   <a class="home" href="#">Home</a>  / Login
		   	 </ul>
		   	 <div class="g_desc"><form action="loginAction.jsp" method="post">
					<table>
						<tr>
							<td><p class="g_2">Email</p></td>
							<td><input id="email" type="text" name="email" value=""></td>
						</tr>
						<tr>
							<td><p class="g_2">Password</p></td>
							<td><input type="password" name="password"></td>
						</tr>
						<tr>
							<td colspan="2"><button class="grey">Submit</button><a href="javascript:reset();" style="padding-left: 20px;">Reset Password</a>
							</td>
						</tr>
					</table>
